  ...
  <body id="home" style="background: linear-gradient(to bottom, #000428, #004e92);">
    ...
    <div class="container mb-3">
        ...
        <div class="row mt-4 mb-4 text-center justify-content-center">
            ...
            <?php 
            $link = file_get_contents("https://islamic-api-zhirrr.vercel.app/api/niatshalat");
            ...
            <div class="col-12 text-white">
                                <div class="row">
                                    <div class="col-md-6 pt-3 pb-3">
                                        <p class="animate__animated animate__rotateInDownLeft"><b><?= $key['name']; ?></b></p>
                                        <p class="animate__animated animate__rotateInDownRight"><b><?= $key['arabic']; ?></b></p>
                                    </div>
                                    <div class="col-md-6 pt-3 pb-3">                                    
                                        <i><p class="animate__animated animate__rotateInDownLeft"><?= $key['latin']; ?></p></i>
                                        <i><p class="animate__animated animate__rotateInUpLeft"><b>Artinya: </b>"<?= $key['terjemahan']; ?>"</p></i>
                                    </div>
                                </div>
