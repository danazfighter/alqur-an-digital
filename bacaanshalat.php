  ...
  <body id="home" style="background: linear-gradient(to bottom, #000428, #004e92);">
    ...
    <div class="container mb-3">
        ...
        <div class="row mt-4 mb-4 text-center justify-content-center">
            ...
            <?php 
            $link = file_get_contents("https://islamic-api-zhirrr.vercel.app/api/bacaanshalat");
            ...
            <div class="col-12 text-white">
                                <div class="row">
                                    <div class="col-md-6 pt-3 pb-3">
                                        <p class="animate__animated animate__fadeInLeft"><b><?= $key['name']; ?></b></p>
                                        <p class="animate__animated animate__fadeInRight"><b><?= $key['arabic']; ?></b></p>
                                    </div>
                                    <div class="col-md-6 pt-3 pb-3">  
                                        <i><p class="animate__animated animate__fadeInDown"><?= $key['latin']; ?></p></i>
                                        <i><p class="animate__animated animate__fadeInUp"><b>Artinya: </b>"<?= $key['terjemahan']; ?>"</p></i>
                                    </div>
                                </div>
