  ...
  <body id="home" style="background: linear-gradient(to bottom, #000428, #004e92);">
    ...
    <div class="container mb-3">
        ...
        <div class="row mt-4 mb-4 text-center justify-content-center">
            ...
            <?php 
            $link = file_get_contents("https://doa-doa-api-ahmadramadhan.fly.dev/api");
            ...
            <div class="col-12 text-white">
                                <div class="row">
                                    <div class="col-md-6 pt-3 pb-3">
                                        <p class="animate__animated animate__fadeInLeft"><b><?= $key['doa']; ?></b></p>
                                        <p class="animate__animated animate__fadeInRight"><b><?= $key['ayat']; ?></b></p>
                                    </div>
                                    <div class="col-md-6 pt-3 pb-3">  
                                        <i><p class="animate__animated animate__fadeInDown"><?= $key['latin']; ?></p></i>
                                        <i><p class="animate__animated animate__fadeInUp"><b>Artinya: </b>"<?= $key['artinya']; ?>"</p></i>
                                    </div>
                                </div>
