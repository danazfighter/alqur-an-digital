  ...
  <body id="home" style="background: linear-gradient(to bottom, #000428, #004e92);">
    ...
    <div class="container mb-3">
        ...
        <div class="row mt-4 mb-4 text-center justify-content-center">
            ...
            <?php 
            $id = $_GET['nomor'];
            $link = file_get_contents("https://equran.id/api/v2/surat/$id");
            $data = json_decode($link, true);
            ?>

            <?php foreach ($data['data']['ayat'] as $key) : ?>

            <div class="container">
            <div class="col-12 text-white">
                                <div class="row">
                                    <div class="col-md-6">
                                        <br><p><b><?= $key['teksArab']; ?></b></p>
                                        <p><?= $key['teksLatin']; ?></p>
                                        <b>Artinya: </b> <i>"<?= $key['teksIndonesia']; ?>"</i>
                                    </div>
                                    <div class="col-md-6">
                                        <br><i>Ayat: <?= $key['nomorAyat']; ?></i><br>
                                        <br><audio controls="" class="pb-3">
                                        <source src="<?= $key['audio']['05']; ?>" type=""></audio>
                                    </div>
                                </div>
